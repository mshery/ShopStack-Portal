...
export default function BrandsPage() {
  const { status, vm, actions } = useBrandsScreen();
  ...
  const handleAddBrand = () => {
    ...
    actions.create(newBrandName.trim());
    setNewBrandName("");
  ...
  return (
    <div className="space-y-6 p-6">
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={!newBrandName.trim() || vm.isCreating}
                    ...
                    <TableCell className="px-6 py-4 text-end">
                      {vm.editingId !== brand.id && (
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() => actions.startEdit(brand)}
      ...
      <DeleteConfirmationModal
        ...
        onConfirm={() => {
          if (brandToDelete) {
            actions.delete(brandToDelete.id);
            setBrandToDelete(null);
          }
        }}
        title="Delete Brand"
        message="Are you sure you want to delete this brand? Brands with products cannot be deleted."
